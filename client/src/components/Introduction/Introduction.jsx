...
const Introduction = () => {
  const words = ["Website Developing", "Artificial Intelligence", "Robotic Process Automation", "PCB Design", "sasa"];
    ...
    <>
      ...
      <div className="flex flex-row place-content-center gap-5 sm:mx-5 md:mx-8 xl:mx-20 px-10 my-10 flex-wrap-reverse">
        <div className="flex flex-col p-2 mt-0 md:mt-2 text-center xl:text-left z-20 w-[650px]">
          ...
          <div className="flex flex-row mx-4 xl:ml-20 font-thin sm:text-sm md:text-2xl mt-2 md:mt-8 text-justify">
            <p>
              I am Bryan, an electrical (control) engineering fresh graduate and
              a professional worker specializing in{" "}
              <span className="inline-block h-[24px] md:h-[32px] overflow-hidden">
                <span
                  ...
                  style={{ transform: `translateY(${-index * (1/words.length*100)}%)` }}
                >
                  {words.map((word, i) => (
